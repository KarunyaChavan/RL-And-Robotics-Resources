...
class AnymalTeacherEnv:
    ...
    def __init__(self, 
        ...
        # CRITICAL: Disable intrinsic CPG base frequency for clean policy learning
        # The environment has a default baseFreq_ = 1.3 * freqScale_ that is always added
        # to the first 4 action channels. Setting stopMode=True disables this intrinsic drive,
        # allowing the policy to learn without constant pressure to counteract oscillation.
        self.env.stopMode = True
